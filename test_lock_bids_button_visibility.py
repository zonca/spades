...
# Reusing the play_hand function from other tests for consistency
...
def test_lock_bids_button_visibility_in_round3(page: Page):
    ...
    play_hand(page, 6, 7, 6, 7) # Play a normal hand
